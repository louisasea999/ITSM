...
public class MySqlPageHepler {
	 ...
	 * @return 分页SQL
	 */
	public static String getPageSql(String querySelect,
																	int offset,
																	int limit) {
...
//																				"") + " limit " + offset + " ," + limit;
	...
	private static int getAfterFormInsertPoint(String querySelect) {
		...
		while (matcher.find()) {
			...
			String text = querySelect.substring(0,
																					fromStartIndex);
	...
	private static boolean isBracketCanPartnership(String text) {
		if (text == null || (getIndexOfCount(	text,
	 ...
	 *          字符
	 */
	private static int getIndexOfCount(	String text,
																			char ch) {
		int count = 0;
